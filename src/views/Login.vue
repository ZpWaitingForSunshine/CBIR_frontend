<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    <h3 class="title">A New Digital Repository for Hyperspectral Imagery Implemented on Cloud Platform</h3>
    ...
    <el-checkbox v-model="checked" checked class="remember">Remember Secret</el-checkbox>
